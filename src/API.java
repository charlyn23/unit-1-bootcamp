///**
// * Created by charlynbuchanan on 4/18/15.
// */
//
...
//                //System.out.println(Customer.all(customerParams)); // Prints out JSON stuff
//                CustomerCollection customerData  = Customer.all(customerParams);
//                JSONObject JSON = (JSONObject) customerData.get("JSON");
//    }
